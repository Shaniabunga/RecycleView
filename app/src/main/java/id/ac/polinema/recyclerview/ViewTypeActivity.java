...
public class ViewTypeActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		teams.add(new TeamLogo("https://upload.wikimedia.org/wikipedia/id/b/b9/Logo_Arema_FC_2017_logo.png", "AREMA"));
		teams.add(new TeamLogo("https://upload.wikimedia.org/wikipedia/id/d/d5/Logo_Persiga_Trenggalek.png", "PERSIGA"));
